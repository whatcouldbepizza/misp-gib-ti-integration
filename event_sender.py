...
class EventProcessor(object):
	...
	def accs_processor(self, event, feed):
		...
		misp_event.info = "Group-IB Threat Intelligence: " + info_dict[feed]
	...
	def phishingkit_processor(self, event, feed):
		...
		new_object_1.add_attribute("Phishing-kit-file-sha256", type="sha256", value=attrs["phishing_kit_file_hash_sha256"])
		new_object_1.add_attribute("Phishing-kit-file-md5", type="md5", value=attrs["phishing_kit_file_hash_md5"])
		new_object_1.add_attribute("Phishing-kit-file-sha1", type="sha1", value=attrs["phishing_kit_file_hash_sha1"])
		new_object_1.add_attribute("Phishing-kit-file-crc32", type="text", value=attrs["phishing_kit_file_hash_crc32"])
		new_object_1.add_attribute("Phishing-kit-file-size", type="text", value=attrs["phishing_kit_file_size"])
		new_object_1.add_attribute("Phishing-kit-file-mime", type="text", value=attrs["phishing_kit_file_mime"])
